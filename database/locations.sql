...
('Rock n Roll', '/assets/img/mountains.png', 'music', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Electronic Game', '/assets/img/mountains.png', 'videogames', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
